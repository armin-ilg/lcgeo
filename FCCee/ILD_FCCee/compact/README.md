...
- 08.2026: Replaced CLD vertex with FCC-SEED vertex consisting of a novel barrel design with overlapping, curved sensors, and modified CLD disks with six single-hit disks with 0.35% X0 per disk.
