...
- August 2026: Still using the IDEA_o1_v04 vertex geometry, but ALLEGRO no longer has the same vertex detector parameters as IDEA. Pixel pitch is changed to 20x20 µm2 everywhere. For the silicon wrapper, conversely to IDEA, only one layer is used. The pitch is changed to 50x50 µm2.
...
- February 2026: The vertex detector and silicon wrapper are now taken from IDEA_o1_v04.
- August 2026: Updates to vertex detector and silicon wrapper as described in ALLEGRO_o1_v04. 